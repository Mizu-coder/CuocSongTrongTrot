...
//        start = new Texture("start.png");
        ...
        start = new Start(Gdx.graphics.getWidth()/3+100, 450,stage);
        bContinue = new Continue(Gdx.graphics.getWidth()/3+100, 370, stage);
        guide = new Guide(Gdx.graphics.getWidth()/3+100, 290, stage);

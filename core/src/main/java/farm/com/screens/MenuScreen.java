...
//        start = new Texture("start.png");
        ...
        start = new Start(Gdx.graphics.getWidth()/3+200, 400,stage);
        bContinue = new Continue(Gdx.graphics.getWidth()/3+200, 360, stage);
        guide = new Guide(Gdx.graphics.getWidth()/3+200, 320, stage);
